...
const sections: DocSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { file: "electron/main.cjs (Ajyal handlers)", description: "IPC Handlers في Electron: ajyal-open-window يفتح BrowserWindow لصفحة login أجيال. يدعم وضعين: credentials (يحقن username/password تلقائياً) و sanad (يفتح الصفحة فقط ليسجل المستخدم عبر سند يدوياً). ajyal-check-login يفحص إذا اكتمل الدخول. ajyal-submit-absence يحقن JavaScript لتعبئة الغياب. ajyal-import-students يستخرج بيانات الطلاب من DOM." },
      { file: "electron/preload.cjs (ajyal API)", description: "واجهة IPC آمنة: يوفر electronAPI.ajyal مع 5 دوال (openWindow, checkLogin, submitAbsence, importStudents, closeWindow) عبر contextBridge. يمنع الوصول المباشر لـ Node.js." },
