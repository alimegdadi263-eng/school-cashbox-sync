...
const sections: DocSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { file: "electron/main.cjs (Ajyal handlers)", description: "IPC Handlers في Electron: ajyal-open-window يفتح BrowserWindow على العنوان الرسمي الحالي لمنصة أجيال ويدعم وضعين: credentials (تعبئة تلقائية لاسم المستخدم/كلمة المرور) و sanad (فتح الصفحة لتسجيل الدخول اليدوي). كما يعالج الروابط الداخلية داخل نفس النافذة. ajyal-check-login يفحص إذا اكتمل الدخول. ajyal-submit-absence يحقن JavaScript لتعبئة الغياب. ajyal-import-students يستخرج بيانات الطلاب من DOM." },
      ...
      { file: "استيراد الطلاب من أجيال", description: "يقرأ DOM صفحة قائمة الطلاب في أجيال ويستخرج: اسم الطالب، الصف/الشعبة، ورقم ولي الأمر. يتم دمجهم مع القائمة الحالية مع تجنب التكرار." },
