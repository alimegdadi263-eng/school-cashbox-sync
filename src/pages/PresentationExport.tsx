...
const slides: Slide[] = [
  ...
  {
    title: "ربط منصة أجيال",
    subtitle: "أتمتة الغياب واستيراد الطلاب",
    content: [
      "طريقتان لتسجيل الدخول: اسم مستخدم + كلمة مرور، أو عبر تطبيق سند",
      "يفتح الموقع الرسمي الحالي لأجيال داخل نافذة سطح المكتب بدل نافذة فارغة",
      "تعبئة الغياب تلقائياً: حقن بيانات الغياب المسجلة مباشرة في منصة أجيال",
      "استيراد الطلاب: سحب بيانات الطلاب (الاسم، الصف، رقم ولي الأمر) من أجيال تلقائياً",
      "اختيار الصفوف: لوحة تفاعلية لاختيار (الكل) أو صفوف محددة قبل الاستيراد أو التعبئة",
      "استمرارية الجلسة: العودة للبرمجية والرجوع لأجيال بدون إعادة تسجيل الدخول",
      "يعمل حصرياً في نسخة سطح المكتب — بيانات الدخول تُحفظ محلياً فقط",
    ],
