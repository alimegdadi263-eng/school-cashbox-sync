...
const troubleshooting = [
  ...
  "فشل إرسال SMS: تأكد من أن تطبيق Traccar SMS Gateway يعمل على الهاتف، وأن صلاحية إرسال SMS مفعّلة، وأن مفتاح API صحيح.",
  "فشل اختبار الاتصال بـ SMS: تأكد أن الهاتف والحاسوب على نفس الشبكة، وأن عنوان الـ IP والمنفذ (8082) صحيحان.",
