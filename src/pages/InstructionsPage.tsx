...
const smsGatewayUsage = [
  ...
  "الخطوة 1 — التطبيق: ثبّت تطبيق SMS Gateway Master على هاتف أندرويد فيه شريحة فعّالة، وامنحه صلاحية الرسائل SMS، وعطّل توفير البطارية له ليبقى يعمل بالخلفية.",
  "الخطوة 2 — تشغيل السيرفر: افتح التطبيق واضغط (Start) لتشغيل السيرفر، سيظهر عنوان مثل http://192.168.1.5:8080، وانسخ أيضاً مفتاح API (API Key) من شاشة الإعدادات.",
  "الخطوة 3 — الشبكة: تأكد أن الهاتف والحاسوب على نفس شبكة الواي فاي (الربط المحلي يعمل عبر نسخة سطح المكتب أو على نفس الشبكة).",
  "الخطوة 4 — الإدخال: اضغط (+ إضافة هاتف جديد)، اختر نوع البوابة (SMS Gateway Master)، ألصق عنوان السيرفر ومفتاح API، اختر الشريحة، ثم (حفظ الكل).",
  "الخطوة 5 — الاختبار: اضغط (🔌 اختبار الاتصال) للتأكد من نجاح الربط قبل الإرسال.",
  "إعدادات متقدمة: إذا كان إصدار التطبيق يستخدم مساراً أو أسماء حقول مختلفة، افتح (⚙️ إعدادات متقدمة) وعدّل المسار /sendsms وأسماء الحقول apikey / number / message / sim أو غيّر الطريقة إلى POST حسب شاشة API في التطبيق.",
  ...
  "البوابة القديمة SMSGate ما زالت مدعومة: اختر نوع البوابة (SMSGate) وأدخل Username و Password و Device ID كالسابق.",
];
