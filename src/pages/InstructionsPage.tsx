...
const ajyalUsage = [
  ...
  "أدخل اسم المستخدم (رقم الموظف) وكلمة المرور الخاصة بحساب مدير المدرسة على منصة أجيال.",
  "اضغط (فتح أجيال وتسجيل الدخول): يفتح البرنامج نافذة داخلية لمنصة أجيال ويعبئ بيانات الدخول تلقائياً.",
  "أدخل رمز OTP يدوياً في النافذة المفتوحة (يصلك على هاتفك).",
  "بعد إدخال OTP، اضغط (تأكيد تسجيل الدخول) في برمجيتك للتأكد من نجاح الدخول.",
